...
Linux: 
    Kommentar in src/app/get_lessons Zeile 11 vor ".encode..." hinzufügen.
...
Ausführen mit "python -m app" aus der Root des Projektordners.
...
Ausgeführt aus Root des Projektordners:
python -m src.configurator
